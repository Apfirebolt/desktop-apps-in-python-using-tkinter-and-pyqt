...
for j in range(3):
    for k in range(3):
        Button(cal, command=lambda x=str(numberpad[i]): pressbtn(x), text=str(numberpad[i]), bg=bg1, fg=fg2,
...
list1 = ['(', ')', '%', 'asin', 'sin', 'log', 'x^2', 'acos', 'cos', 'ln', 'x^3', 'atan', 'tan', 'e^x', '1/x', 'x^y',
         'e', "π", '√x', 'sgn']
list2 = ['(', ')', '%', 'asin(', 'sin(', 'log(', '^2', 'acos(', 'cos(', 'ln(', '^3', 'atan(', 'tan(', 'e^', '1/', '^',
         'e', "π", '√(', 'sgn(']
i = 0
for j in range(5):
    for k in range(4):
