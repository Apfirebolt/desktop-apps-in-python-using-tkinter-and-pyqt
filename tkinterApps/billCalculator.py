...
class Application(Frame):
    ...
    def create_widget(self):
        ...
        Checkbutton(self, text="Spaghetti With Tomato,Black Olives and Capers", variable=self.sphag).grid(row=10,
                                                                                                          column=0,
                                                                                                          sticky=W)
        ...
        Checkbutton(self, text="Chicken With Tomato & Peppers", variable=self.chic_tmto).grid(row=11, column=0,
                                                                                              sticky=W)
